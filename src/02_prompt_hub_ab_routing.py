...
PROMPT_V1_NAME = "hatanphong-rag-prompt-v1"
PROMPT_V2_NAME = "hatanphong-rag-prompt-v2"
...
SYSTEM_V1 = (
    ...
    "Nếu không tìm thấy thông tin trong context, hãy nói 'Tôi không tìm thấy thông tin này'."
)
...
# SYSTEM_V2 — phong cách có cấu trúc, expert tone, 3-5 câu
SYSTEM_V2 = (
    "Bạn là chuyên gia AI. Đọc kỹ context, xác định các facts liên quan, "
    "viết câu trả lời rõ ràng và có tổ chức (3-5 câu). "
    "Luôn dựa trên thông tin trong context, không suy đoán. "
    "Nếu không tìm thấy thông tin, hãy nói 'Không có thông tin nào trong context'."
)
...
def push_prompts_to_hub(client: Client):
    ...
    try:
        url = client.push_prompt(
            PROMPT_V1_NAME,
            object=PROMPT_V1,
            description="V1 – ngắn gọn, thân thiện"
        )
    ...
    try:
        url = client.push_prompt(
            PROMPT_V2_NAME,
            object=PROMPT_V2,
            description="V2 – có cấu trúc, chuyên nghiệp"
        )
